...
Moreover, it has been extended  to various logic systems. See~\cite{eiter2019brief} for a recent and comprehensive survey.
...
What's more, forgetting in logic programs under answer-set semantics, which is a non-monotonic logic program, are also considered, see~\cite{DBLP:Zhang:AIJ2006,Eiter2008Semantic,Wong:PhD:Thesis,Yisong:KR:2012,Yisong:IJCAI:2013,wang2013forgetting,gonccalves2020limits}  for more details.
