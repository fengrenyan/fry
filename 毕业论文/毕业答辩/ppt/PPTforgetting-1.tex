...
\begin{frame}
	...
	\begin{figure}
		...
		\begin{tikzpicture}[scale=0.8]
			...
			\node[rectangle,rounded corners =4pt,minimum width =40pt, minimum height =15pt,draw=blue,fill=blue!20] (s2) at(0,3) {{\scriptsize 有界互模拟}};
			\node[rectangle,rounded corners =4pt,minimum width =40pt, minimum height =15pt,draw=orange,fill=orange!60] (s3) at(2,3) {{\scriptsize 特征数$ch(\Hm,V)$}};
			\node[rectangle,rounded corners =4pt,minimum width =40pt, minimum height =15pt,draw=blue,fill=blue!20] (s4) at(0,2) {{\scriptsize 计算树互模拟}};
...
\begin{frame}
	...
	\begin{figure}
		...
		\begin{tikzpicture}[scale=0.8]
			...
			\node[rectangle,rounded corners =4pt,minimum width =40pt, minimum height =15pt,draw=orange,fill=orange!60] (s5) at(0,0) {{\scriptsize 计算树特征公式}};
...
\begin{frame}
	...
	\begin{figure}
		...
		\begin{tikzpicture}[scale=0.8]
			...
			\node[rectangle,rounded corners =4pt,minimum width =40pt, minimum height =15pt,draw=green,fill=green!60] (s6) at(3,2) {{\scriptsize 特征公式}};
