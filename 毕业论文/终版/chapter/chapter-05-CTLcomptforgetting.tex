...
\begin{figure*}[!htb]
	\centering
	% Requires \usepackage{graphicx}
	\includegraphics[width=15cm]{chapter04/frame1.png}\\
	\caption{基于归结的遗忘的主要流程图}
	\label{Fig:chapter05:v1uv2}
\end{figure*}
...
\begin{algorithm}[tb]
	...
	用$\ALL\GLOBAL\varphi$替换$\Sigma$中的初始子句“$\ALL\GLOBAL(\start\rto\varphi)$”\;\tcp*{去除$\start$}
...
\begin{figure*}[!htb]
	\centering
	\subfigure[平均CPU时间(s)]{
		\includegraphics[width=7.5cm]{chapter04/PRototalAveTime1.png}
	}
	\subfigure[$|V|=25$时所使用CPU时间箱线图 % and $|\varphi|~\in~ \{10, 15,\dots, 50\}$
	]{
		\includegraphics[width=7cm]{chapter04/ProBox(10-50)_251.png}
	}
