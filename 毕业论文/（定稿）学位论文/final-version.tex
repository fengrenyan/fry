...
%\begin{center}
%	\heiti\zihao{3}{
%		学科专业：\uwave{\hbox to 70mm{~~~~~~~~~~~~~~~~软件工程~~~~~~~~~~~~~~~~~~~~~~~~}}\\
%		研究方向：\uwave{\hbox to 70mm{~~~软件工程技术与人工智能~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~}}
%	}
%\end{center}
%
%\vspace*{70pt}
...
\nomenclature[N]{$\Hm=(S,R,L)$}{Kripke 结构}
...
\input{chapter/chapter-03-fanyinshiForget.tex}
\input{chapter/chapter-04-fanyingshiApplication.tex}
\input{chapter/chapter-05-CTLcomptforgetting.tex}
%\input{chapter/chapter-03-forgCTLproperty} %CTL下遗忘的定义及语义属性 //CTL下的遗忘理论的定义及其语义属性
%\input{chapter/chapter-04-resolution.tex} %基于消解CTL遗忘的计算方法     //  基于消解CTL遗忘的计算方
%\input{chapter/chapter-05-modelbased.tex} %基于模型的CTL遗忘的计算方法  // 差分隐私数据发布的最优化模型
%\input{chapter/chapter-06-mucalculus.tex} %mu演算的遗忘理论   // 差分隐私策略机制的均衡优化模型
%\input{chapter/chapter-07-WSC.tex} %基于遗忘的最弱充分条件计算
%\input{chapter/chapter-08-experiments.tex} %实验结果展示
\input{chapter/chapter-09-conclusion.tex}
...
% \item [2.] \textbf{Ningbo Wu}, Changgen Peng (Corresponding author), Kun Niu. A privacy-preserving game model for local differential privacy by using information-theoretic approach[J]. IEEE ACCESS,2020,8:216741-216751. DOI号 10.1109/ACCESS.2020.\\3041854. SCI 2 区，IF 3.8
% \item [3.]\textbf{吴宁博},彭长根(通信作者),田有亮,牛坤,丁红发.基于率失真的差分隐私效用优化模型[J].计算机学报,2020,43(8):1463-1478. DOI:10.11897/SP.J.1016.2020.01463, CCF 推荐中文科技期刊A类,贵州大学(一级学术期刊)
% \item [4.] \textbf{吴宁博},彭长根(通信作者),牟其林. 面向关联属性的差分隐私信息熵度量方法[J].电子学报,2019,47(11):2337-2343. DOI:10.3969/j.issn.0372-2112.2019.11.015,\\CCF 推荐中文科技期刊A类,贵州大学(一级学术期刊)
%
%\end{itemize}
%\end{resumesection}
