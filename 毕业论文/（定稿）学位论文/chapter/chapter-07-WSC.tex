...
\section{最强必要条件和最弱充分条件}
\label{chapter07:sec:snc}
...
由第\ref{chapter05}章可知，任意$\Ha$上的有限初始结构$\Hm$（为了简化符号，本节用$\Hm$代替初始结构$(\Hm,s_0)$）都能用一个$\CTL$公式——特征公式${\cal F}_{\Ha}(\Hm)$来表示。%，此公式也是$\mu$-句子。
